export const resumeData = {
  personalInfo: {
    ...
    about:
      "IT professional with 9+ years of experience, including 8 years in IT Support and 1 year as a Server Engineer. Skilled in delivering effective technical solutions to enhance operational efficiency. Keen interest in cloud technologies and infrastructure, with a strong drive to adopt and implement scalable cloud-based systems.",
  },
  workExperience: [
    {
      id: "bilibili",
